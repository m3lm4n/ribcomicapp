 ...
 */
@TargetApi(16)
public class GalleryExoPlayer implements ExoPlayer {
	...
	public GalleryExoPlayer(Context context, TrackSelector trackSelector, LoadControl loadControl,
	...
	private final class ComponentListener implements VideoRendererEventListener,
		...
		public void onRenderedFirstFrame(Surface surface) {
			if (videoListener != null && GalleryExoPlayer.this.surface == surface) {
